  ...
  render() {
    ...
    <View style={styles.container}>
      <Header
        ...
        rightComponent={<TouchableOpacity style={{backgroundColor:'#bada55', width: wp('25%'), padding: 5 }}><Text style={{fontWeight: "bold" ,alignSelf: 'center', color:'#fff', padding: 5}}>LOGOUT</Text></TouchableOpacity> }
